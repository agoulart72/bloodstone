...
title: Barbarian
slug: barbarian
image: barbarian_2.jpg
sector: 1
image2: barbarian_2_cl.png
layout: phb
---
Considerados selvagens, estes guerreiros formidáveis são geralmente encontrados nas regiões do norte, nas terras dos Vos e dos Rjurik. Tribos de humanos, goliaths e therion destas regiões possuem bárbaros entre seus maiores heróis.
...
### Proficiencies
- Skills (2): [Animal Handling](/bloodstone/rules/skills#Animal_Handling), [Athletics](/bloodstone/rules/skills##Skills), [Intimidation](/bloodstone/rules/skills##Skills), [Nature](/bloodstone/rules/skills##Skills), [Perception](/bloodstone/rules/skills#Skills), or [Survival](/bloodstone/rules/skills#Skills)
...
You gain an uncanny sense of when things aren’t as they should be, giving you an edge when you dodge perils. You have Advantage on Dexterity saving throws unless you have the [Incapacitated](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition) condition.
...
**_Staggering Blow._** The target has Disadvantage on the next saving throw it makes, and it can’t make [Opportunity Attacks](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#OpportunityAttack) until the start of your next turn.
